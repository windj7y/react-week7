...
const Orders = () => {
  ...
  return (<>
    <div className="container">
      <h2 className="fs-3 mb-4">訂單管理</h2>
      {
        orders.length > 0 && <div className="text-end mb-4">
          <button className="btn btn-primary hover-primary" onClick={removeOrders}>刪除所有訂單</button>
        </div>
      }
        ...
        <tbody>
          {orders && orders.length > 0 ? (
            ...
            <tr key={ order.id }>
              ...
              <td>
                <button type="button" className="btn btn-outline-secondary hover-primary btn-sm" title="檢視" onClick={() => {
